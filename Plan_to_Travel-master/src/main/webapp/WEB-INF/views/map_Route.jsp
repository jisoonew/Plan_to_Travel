    ...
    <div id="map_div" style="position: relative;">
        ...
        <div class="_map_layer_overlay">
            ...
            <div class="_map_overlay_row">
                <input type="text" id="searchStartAddress" class="_search_entry _search_entry_short"
                    placeholder="출발지를 입력하세요" onkeyup="onKeyupSearchPoi(this);">
                <button onclick="clickSearchPois(this);" class="_search_address_btn"
                    style="margin-top: 14px; margin-bottom: 14px; pointer-events: all; cursor: pointer;">
                </button>
                <div class="__space_13_w"></div>
                <input type="text" id="searchEndAddress" class="_search_entry _search_entry_short"
                    placeholder="목적지를 입력하세요" onkeyup="onKeyupSearchPoi(this);">
                <button onclick="clickSearchPois(this);" class="_search_address_btn"
                    style="margin-top: 14px; margin-bottom: 14px; pointer-events: all; cursor: pointer;">
                </button>
            ...
            <div id="wpList">
                ...
                <div class="waypoint_input _map_overlay_row" data-idx="0">
                    ...
                    <input type="text" class="_search_entry _search_entry_short" onkeyup="onKeyupSearchPoi(this);"
                        placeholder="경유지를 입력하세요.">
                    <button onclick="clickSearchPois(this);" class="_search_address_btn"
                        style="margin-top: 14px; margin-bottom: 14px; pointer-events: all; cursor: pointer;"></button>
    ...
    <script>
        ...
        map.addListener("contextmenu", function onContextmenu(evt) {
            ...
            marker1 = new Tmapv3.Marker({
                ...
                <
                img src = "/lib/img/_icon/marker_blue.svg"
                ...
                success: function (response) {
                    ...
                    if (response.resultData.header) {
                        ...
                        for (var i in resultlinkPoints) {
                            var lineLatLng = new Tmapv3.LatLng(resultlinkPoints[i].location
                                .latitude, resultlinkPoints[i].location.longitude);
                        ...
                        let resultStr = ' <
                            ...
                            <
                            div class = "__reverse_geocoding_result"
                        style = "flex-grow: 1;" >
                            <
                            p class = "_result_text_line" > 총거리: $ {
                                tDistance
                            }
                        m < /p> <
                            p class = "_result_text_line" > 제한속도: $ {
                                tTime
                            }
                        km / h < /p> <
                            p class = "_result_text_line" > 도로명: $ {
                                rName
                            } < /p> <
                            ...
                            <
                            div class = "_search_item_button"
                        onclick = "enterDest('start', '${rName}', '${lon}', '${lat}');" >
                            출발 <
                            /div> <
                            div class = "_search_item_button"
                        onclick = "enterDest('end', '${rName}', '${lon}', '${lat}');" >
                            도착 <
                            /div> <
                            div class = "_search_item_button"
                        onclick = "enterDest('wp', '${rName}', '${lon}', '${lat}');" >
                            경유 <
                            /div> <
                            /div> <
                            /div> <
        ...
        map.addListener("click", function onClick(evt) {
            ...
            var params = {
                onComplete: function (result) { //데이터 로드가 성공적으로 완료 되었을때 실행하는 함수 입니다.
                    ...
                    style = "flex-grow: 1;" >
                        <
                        p class = "_result_text_line" > 새주소: $ {
                            newRoadAddr
                        } < /p> <
                        p class = "_result_text_line" > 지번주소: $ {
                            jibunAddr
                        } < /p> <
                        p class = "_result_text_line" > 좌표(WSG84): $ {
                            lat
                        }, $ {
                            lon
                        } < /p> <
        ...
        function searchPois() {
                        ...
                        for (var k in resultpoisData) {
                            ...
                            marker3.addListener("click", function (evt) {
                                        ...
                                        id = "poi_${k}" >
                                            ...
                                            <
                                            div class = "_search_item_poi_icon_text" > $ {
                                                Integer.parseInt(k) + 1
                                            } < /div> <
                                            /div> <
                                            /div> <
                                            ...
                                            <
                                            p class = "_search_item_info_title" > $ {
                                                name
                                            } < /p> <
                                            p class = "_search_item_info_address" > $ {
                                                fullAddressRoad
                                            } < /p> <
                                            p class = "_search_item_info_address" > 중심점: $ {
                                                lat
                                            }, $ {
                                                lon
                                            } < /p> <
                                            p class = "_search_item_info_address" > 입구점: $ {
                                                frontLat
                                            }, $ {
                                                frontLon
                                            } < /p> <
                                        ...
                                        onclick = 'poiDetail("${id}", "${k}");' >
                                            ...
                                            <
                                            div class = "_search_item_button"
                                        onclick = "enterDest('start', '${name}', '${lon}', '${lat}');" >
                                            출발 <
                                            /div> <
                                            div class = "_search_item_button"
                                        onclick = "enterDest('end', '${name}', '${lon}', '${lat}');" >
                                            도착 <
                                            /div> <
                                            div class = "_search_item_button"
                                        onclick = "enterDest('wp', '${name}', '${lon}', '${lat}');" >
                                            경유 <
                                            /div> <
                                            /div>
                                            ...
                                            /div>
                                        $ {
                                            (resultpoisData.length - 1) == Integer.parseInt(k) ? "" :
                                                '<div class="_search_item_split"></div>'
                                        }
                                        ';
                                    ...
                                    innerHtml += "</div></div>"; $("#apiResult").html(
                                    innerHtml); //searchResult 결과값 노출
                    ...
                    function poiDetail(poiId, thisK) {
                        for (let tMarker of markerPoi) {
                            ...
                            markerPoi[thisK].setIconHTML(' <
                                ...
                                var scrollOffset = $("#poi_" + thisK)[0].offsetTop - $("._result_panel_scroll")[0]
                                    .offsetTop
                                $("._result_panel_scroll").animate({
                                    scrollTop: scrollOffset
                                }, 'slow'); $("._result_panel_scroll ._search_item_poi_icon").removeClass(
                                    "_search_item_poi_icon_blue"); $("#poi_" + thisK).find('._search_item_poi_icon')
                                .addClass("_search_item_poi_icon_blue");
                                // 기존 라벨 지우기
                                if (labelArr.length > 0) {
                                    for (var i in labelArr) {
                                        labelArr[i].setMap(null);
                                ...
                                var params = {
                                    onComplete: function (result) {
                                        ...
                                        var parkingString = (detailInfo.parkFlag == "0" ? "주차 불가능" : (
                                            detailInfo.parkFlag == "1" ? "주차 가능" : ""));
                                        ...
                                        if (tel !== "") {
                                            content +=
                                                '<div class="_tmap_preview_popup_address">${tel}</div>';
                                        }
                                        if (parkingString !== "") {
                                            content +=
                                                '<div class="_tmap_preview_popup_address">${parkingString}</div>';
                                        }
                                        ...
                                        $("#map_div ._tmap_preview_popup_text").parent().parent().css(
                                            'z-index', 10);
                            ...
                            function routesPedestrian() {
                                return new Promise(function (resolve, reject) {
                                    ...
                                    var params = {
                                        onComplete: function (result) {
                                            ...
                                            var appendHtml = ' <
                                                ...
                                                <
                                                div class = "_route_item_type ${drawMode == "
                                            apiRoutesPedestrian " ? "
                                            __color_blue " : "
                                            "}"
                                            onclick = "routesRedrawMap('apiRoutesPedestrian');"
                                            style = "cursor:" > 보행자 경로 안내 < /div> <
                                            ...
                                            if (drawMode == "apiRoutesPedestrian") {
                                                ...
                                                markerStart = new Tmapv3.Marker({
                                                    ...
                                                    style = "position:relative;" >
                                                    <
                                                    img src = "/lib/img/_icon/marker_red.svg"
                                                    style =
                                    ...
                                    tData.getRoutePlanForPeopleJson(startLatLng, endLatLng, "출발지", "도착지",
                                        optionObj, params);
                                });
                            }
                            ...
                            */
                            async function routesCarInit() {
                                ...
                                for (var mode of modes) {
                                    await routesCar(mode)
                                        .then(v => {
                                            console.log("complete routePlan: mode: ", v);
                                        });
                                    ...
                                    var params = {
                                        onComplete: function (result) {
                                            ...
                                            var appendHtml = ' <
                                                ...
                                                <
                                                div class = "_route_item_type ${drawMode == "
                                            apiRoutesCar_ " + mode || drawMode == "
                                            apiRoutesMulti_ " + mode ? "
                                            __color_blue " : "
                                            "}"
                                            onclick = "routesRedrawMap('apiRoutesCar', '${mode}');" >
                                                $ {
                                                    modes[mode]
                                                } < /div> <
                                                div class = "_route_item_info" >
                                            ...
                                            if (drawMode == "apiRoutesCar_" + mode || drawMode ==
                                                "apiRoutesMulti_" + mode) {
                                                reset();
                                                var positionBounds = new Tmapv3
                                            .LatLngBounds(); //맵에 결과물 확인 하기 위한 LatLngBounds객체 생성
                                                for (var i in resultData) { //for문 [S]
                                                    ...
                                                    if (geometry.type == "LineString") {
                                                        ...
                                                        for (var j in geometry.coordinates) {
                                                            var latlng = new Tmapv3.LatLng(geometry
                                                                .coordinates[j][1], geometry
                                                                .coordinates[j][0]);
                                                            positionBounds.extend(
                                                            latlng); // LatLngBounds의 객체 확장
                                                        ...
                                                        var markerPosition = new Tmapv3.LatLng(geometry
                                                            .coordinates[1], geometry.coordinates[0]
                                                            );
                                                        if (properties.pointType == "S") { //출발지 마커
                                                            markerStart = new Tmapv3.Marker({
                                                                ...
                                                                /div>
                                                                ',
                                                                offset: new Tmapv3.Point(24,
                                                                    38),
                                                                iconSize: new Tmapv3.Size(24,
                                                                    38),
                                                                map: map
                                                            });
                                                        } else if (properties.pointType ==
                                                            "E") { //도착지 마커
                                                            markerEnd = new Tmapv3.Marker({
                                                                position: markerPosition,
                                                                iconHTML: ' <
                            ...
                            function onMultiButton(btn) {
                                ...
                                $("#wpList").append(' <
                                    div class = "__space_10_h" > < /div> <
                                    div class = "waypoint_input _map_overlay_row"
                                    data - idx = "0" >
                                    <
                                    input type = "hidden"
                                    name = "multipos" / >
                                    <
                                    input type = "text"
                                    class = "_search_entry _search_entry_short"
                                    onkeyup = "onKeyupSearchPoi(this);"
                                    placeholder = "경유지를 입력하세요."
                                    style = "padding-right: 45px;" >
                                    <
                                    button class = "wp_add"
                                    onclick = "onMultiButton(this);" > < /button> <
                                    /div>
                                    ');
                                    // 총 개수가 5개 이상이면 - 로 변경
                                    ...
                                    $(".waypoint_input").each(function (idx) {
                                        $(this).removeClass('wp_add wp_clear');
                                        $(this).attr('data-idx', idx);
                                    }); $(".waypoint_input").removeClass('texton'); $(".waypoint_input:last")
                                    .addClass("texton");
                                }
                                ...
                                function routesRedrawMap(mode, carmode) {
                                    ...
                                    $("#apiResult").find('#' + drawMode).find('._route_item_type').addClass(
                                        '__color_blue');
                                }
                                ...
                                function enterDest(type, address, x, y) {
                                    ...
                                    if (type == 'start') {
                                        ...
                                        const prependHtml = ' <
                                            div class = "__space_10_h" > < /div> <
                                            div class = "waypoint_input _wp_not_empty _map_overlay_row"
                                        data - idx = "0" >
                                            <
                                            input type = "hidden"
                                        name = "multipos"
                                        ...
                                        style = "padding-right: 45px;" >
                                            <
                                            button onclick = "clickSearchPois(this);"
                                        class = "_delete_address_btn"
                                        style =
                                            "margin-top: 14px; margin-bottom: 14px; pointer-events: all; cursor: pointer;" >
                                            < /button> <
                                            div style = "width: 90px;" > < /div> <
                                            /div>
                                        ';
            ...
            `);
                                    ...
                                    } else if (type.startsWith("apiRouteSequential_") || type.startsWith(
                                            "routesOptimization")) {
