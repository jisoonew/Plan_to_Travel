        ...
        <div class="_map_layer_overlay">
            ...
            <div class="_map_overlay_row">
                <div id="car_start_div">
                    <input type="text" id="searchStartAddress_car" class="_search_entry _search_entry_short"
                        placeholder="출발지를 입력하세요" onkeyup="onKeyupSearchPoi(this);">
                    <button id="car_start_btn" onclick="clickSearchPois_car(this);"
                        class="_search_address_btn btn btn-primary btn-sm"
                ...
                <div id="car_end_div">
                    <input type="text" id="searchEndAddress_car" class="_search_entry _search_entry_short"
                        placeholder="목적지를 입력하세요" onkeyup="onKeyupSearchPoi(this);">
                    <button id="car_end_btn" onclick="clickSearchPois_car(this);"
                        class="_search_address_btn btn btn-primary btn-sm"
                        style="margin-top: 14px; margin-bottom: 14px; pointer-events: all; cursor: pointer;">
                        도착
                    </button>
                ...
                <div class="_btn_action_car _btn_action-search __color_grey btn btn-primary btn-sm"
                    style="margin-top: -85px; margin-left: 240px;" onclick="apiSearchRoutes_car();">검색</div>
            </div>
            ...
            <div id="wpList_car">
                ...
                <div class="waypoint_input _map_overlay_row" data-idx="0">
                    ...
                    <input type="text" class="_search_entry_car _search_entry_short" style="margin-top: -40px;"
                        onkeyup="onKeyupSearchPoi(this);" placeholder="경유지를 입력하세요.">
                    <button onclick="clickSearchPois_car(this);" class="_search_address_btn btn btn-primary btn-sm"
                        style="margin-top: -40px; margin-bottom: 14px; pointer-events: all; cursor: pointer;">경유지</button>
                ...
                success: function (response) {
                    ...
                    if (response.resultData.header) {
                        ...
                        for (var i in resultlinkPoints) {
                            var lineLatLng = new Tmapv2.LatLng(resultlinkPoints[i].location
            ...
            var params = {
                ...
                `;
                    ...
                    for (var k in resultpoisData) {
                        ...
                        var fullAddressRoad_car = resultpoisData[k].newAddressList.newAddress[0]
                        .fullAddressRoad;

                        const marker3_car = new Tmapv2.Marker({
                            position: markerPosition,
                            icon: "http://tmapapi.sktelecom.com/upload/tmap/marker/pin_b_m_" + k +
                                ".png",
                            iconHTML: `
                            <div class='_t_marker' style="position:relative;" >
                        ...
                        \${(resultpoisData.length-1) == Number(k) ? "": ` < div class = "_search_item_split" > <
                            /div>`}
                        `;
 ...
 */                            
                if(tel !== "") {
                    content += ` < div class = "_tmap_preview_popup_address" > \$ {
                            tel
                        } < /div>`;
                    }
                    if (parkingString !== "") {
            ...
            return new Promise(function (resolve, reject) {
                ...
                var params = {
                    ...
                    `;
                        ...
                        if (drawMode == "apiRoutesCar_" + mode || drawMode == "apiRoutesMulti_" +
                            mode) {
                            reset();
                            ...
                            for (var i in resultData) { //for문 [S]
                                ...
                                if (geometry.type == "LineString") {
                                    ...
                                    for (var j in geometry.coordinates) {
                                        var latlng = new Tmapv2.LatLng(geometry.coordinates[j][1],
                                    ...
                                    var markerPosition = new Tmapv2.LatLng(geometry.coordinates[1],
                ...
                success: function (response) {
                        ...
                        for (var i = 0; i < data.features.length; i++) {
                            ...
                            if (feature.geometry.type == "LineString") {
                                ...
                                for (var j = 0; j < feature.geometry.coordinates.length; j++) {
                                    var startPt = new Tmapv2.LatLng(feature.geometry.coordinates[j][
                                        1
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            var tDistance = "총 거리 : " + (resultData[0].properties
                                .totalDistance / 1000).toFixed(1) + "km,";
                            var tTime = " 총 시간 : " + (resultData[0].properties
                                .totalTime / 60).toFixed(0) + "분,";
                            var tFare = " 총 요금 : " + resultData[0].properties
                                .totalFare + "원,";
                            var taxiFare = " 예상 택시 요금 : " + resultData[0].properties
                                .taxiFare + "원";
                            ...
                            for (var i = 0; i < newData.length; i++) {
                                ...
                                if (type == "Point") {
                                    var linePt = new Tmapv2.LatLng(mData.geometry
                                        .coordinates[1], mData.geometry.coordinates[
                                            0]);
                                    PTbounds.extend(linePt);
                                } else {
                                    var startPt, endPt;
                                    for (var j = 0; j < mData.geometry.coordinates
                                        .length; j++) {
                                        var linePt = new Tmapv2.LatLng(mData.geometry
                                            .coordinates[j][1], mData.geometry
                                            .coordinates[j][0]);
                                        PTbounds.extend(linePt);
                                    }
                                }
