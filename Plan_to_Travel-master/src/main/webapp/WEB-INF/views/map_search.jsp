		...
		$(document).ready(function () {
			...
			function addMarker(map, markerLayer, latitude, longitude) {
				if (marker1_home) {
					...
					var icon = new Tmapv2.MarkerImage("http://tmapapi.sktelecom.com/upload/tmap/marker/pin_b_m_p.png",
						new Tmapv2.Size(24, 38), new Tmapv2.Point(-(24 / 2), -38));
						...
						$.ajax({
							...
							success: function (response) {
								...
								if (map_div_home && markerLayer) {
									...
									addMarker(map_div_home, markerLayer, response
